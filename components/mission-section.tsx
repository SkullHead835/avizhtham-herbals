    ...
    <section ref={sectionRef} id="mission" className="py-24 lg:py-32 px-6">
      <div className="relative max-w-7xl mx-auto rounded-[48px] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img src="/images/mission-herbal.png" alt="Herbal ingredients and traditional wellness" className="w-full h-full object-cover" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="reveal opacity-0 animation-delay-200 font-serif text-3xl md:text-4xl lg:text-5xl font-medium text-background text-balance mb-8">
                Natural Healing Through Traditional Herbal Care
              </h2>
              <div className="reveal opacity-0 animation-delay-400 space-y-6 text-background/90 leading-relaxed">
                <p>
                  ...
                  the highest standards of quality and nurture your well-being naturally. We fuse traditional herbal wisdom 
                  with modern wellness practices.
                </p>
                <p>
                  Our clinic is dedicated to providing premium herbal products that support your health journey. From Triphala 
                  shampoos to hibiscus oils and goat milk soaps, each formula is carefully crafted to deliver real, tangible benefits 
                  without compromise.
                </p>
              </div>
